...
@pytest.mark.asyncio
async def test_normal_user(single_tenant_app, mock_openid_and_keys, freezer, current_cases):
...
@pytest.mark.asyncio
async def test_no_keys_to_decode_with(single_tenant_app, mock_openid_and_empty_keys, current_cases):
    test_version = current_version(current_cases)
...
@pytest.mark.asyncio
async def test_normal_user_rejected(single_tenant_app, mock_openid_and_keys, current_cases):
    test_version = current_version(current_cases)
    async with AsyncClient(
        app=app,
        base_url='http://test',
...
@pytest.mark.asyncio
async def test_invalid_token_claims(single_tenant_app, mock_openid_and_keys, current_cases):
    test_version = current_version(current_cases)
    async with AsyncClient(
        app=app,
        base_url='http://test',
...
@pytest.mark.asyncio
async def test_no_valid_keys_for_token(single_tenant_app, mock_openid_and_no_valid_keys, current_cases):
    test_version = current_version(current_cases)
    async with AsyncClient(
        app=app,
        base_url='http://test',
...
@pytest.mark.asyncio
async def test_expired_token(single_tenant_app, mock_openid_and_keys, current_cases):
    test_version = current_version(current_cases)
    async with AsyncClient(
        app=app,
        base_url='http://test',
...
@pytest.mark.asyncio
async def test_evil_token(single_tenant_app, mock_openid_and_keys, current_cases):
...
@pytest.mark.asyncio
async def test_exception_raised(single_tenant_app, mock_openid_and_keys, mocker, current_cases):
    test_version = current_version(current_cases)
...
@pytest.mark.asyncio
async def test_change_of_keys_works(single_tenant_app, mock_openid_ok_then_empty, freezer, current_cases):
    """
