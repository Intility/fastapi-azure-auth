...
## Getting started
First, either create your `.env` file and fill out your variables or insert them directly in your variables later.
...
```python {1,5,8-19,21} title="main.py"
...
We pass the `app_client_id=` to be our Backend application ID, our `tenant_id` to be our Tenant ID, and then lastly our
...
![fastapi_1_authorize_button](../../static/img/single-tenant/fastapi_1_authorize_button.png)
![fastapi_2_not_authenticated](../../static/img/single-tenant/fastapi_2_not_authenticated.png)
...
![fastapi_3_authenticate](../../static/img/single-tenant/fastapi_3_authenticate.png)


Consent to the permissions requested:

![fastapi_4_consent](../../static/img/single-tenant/fastapi_4_consent.png)
