...
```python {4-5,14,16-31,58-64} title="main.py"
import uvicorn
from fastapi import FastAPI
from fastapi.middleware.cors import CORSMiddleware
...
class Settings(BaseSettings):
    ...
    def SCOPES(self) -> dict:
        return {
            f'api://{self.APP_CLIENT_ID}/{self.SCOPE_DESCRIPTION}': self.SCOPE_DESCRIPTION,
        }
