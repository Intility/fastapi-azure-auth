...
![6_authentication_method](../../static/img/single-tenant/Authentication_Add_a_platform.png)  
  
 
 Now enter `http://localhost:8000/oauth2-redirect` as the Redirect URLs and click on Configure as shown below:
  
![7_authentication_method_congire_single_page_app](../../static/img/single-tenant/signle_tenant_redirect_url_configure.png ) 
...
Now if you click on the manifest you should see the changes you have made as shown below:
 ...
 ![10_updated_manifest](../../static/img/single-tenant/updated_manifest.png) updated_manifest.png
