...
![5_add_scope_props](../../static/img/single-tenant/5_add_scope_props.png)
 ...
 #### Step 5 - Add a new authentication method
...
![12_authentication_method_congire_single_page_app](../../static/img/single-tenant/12_signle_tenant_redirect_url_configure.png) 
  
  
 #### Step 6 -  Allow OpenAPI to talk to the backend
 To allow OpenAPI to talk to the backend API, you must add API permissions to the OpenAPI app registration.
In the left menu, go to **API Permissions** and **Add a permission**.
...
Now if you click on the manifest you should see the changes you have made as shown below:
 ...
 ![10_updated_manifest](../../static/img/single-tenant/13_updated_manifest.png) updated_manifest.png
